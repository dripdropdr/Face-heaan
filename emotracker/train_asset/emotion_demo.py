...
if __name__ == '__main__':
	...
	# cmd = f'python MTCNN_alignment_with_video.py -i {save_dir} -o {save_dir} --size 112 -q'
	# save cropped faces
	# os.system(cmd)
	cmd = f'python create_annotation_file/Aff-wild2/create_test_set_file.py --video_dir {save_dir} --data_dir{root_dir}'
	cmd = f'python run_pretrained_model.py --image_dir {root_dir} --model_type CNN-RNN --seq_len 32 --batch_size 6 --eval_with_students --save_dir {pred_dir} --workers 4 --ensemble'
	# save predictions
	os.system(cmd)
	# generate images
