...
class Resnet50_ferplus_dag(nn.Module):
    ...
    def forward(self, data):
        ...
        conv2_1 = torch.add(conv2_1_1x1_proj_bn, conv2_1_1x1_increase_bn, alpha=1) # torch.add(conv2_1_1x1_proj_bn, 1, conv2_1_1x1_increase_bn)
        ...
        conv2_2 = torch.add(conv2_1x, conv2_2_1x1_increase_bn, alpha=1) # torch.add(conv2_1x, 1, conv2_2_1x1_increase_bn)
        ...
        conv3_3 = torch.add(conv3_2x, conv3_3_1x1_increase_bn, alpha=1) # torch.add(conv3_2x, 1, conv3_3_1x1_increase_bn)
        ...
        conv3_4 = torch.add(conv3_3x, conv3_4_1x1_increase_bn, alpha=1) # torch.add(conv3_3x, 1, conv3_4_1x1_increase_bn)
        ...
        conv4_1 = torch.add(conv4_1_1x1_proj_bn, conv4_1_1x1_increase_bn, alpha=1) # torch.add(conv4_1_1x1_proj_bn, 1, conv4_1_1x1_increase_bn)
        ...
        conv4_2 = torch.add(conv4_1x, conv4_2_1x1_increase_bn, alpha=1) # torch.add(conv4_1x, 1, conv4_2_1x1_increase_bn)
